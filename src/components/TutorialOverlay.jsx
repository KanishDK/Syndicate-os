            ...
            <div className="fixed bottom-24 right-4 z-[90] pointer-events-auto animate-in slide-in-from-right duration-300">
                ...
                >
                    <div className="relative">
                        <i className={`fa-solid ${currentStep.icon} text-theme-primary text-lg group-hover:text-theme-text-primary transition-colors`}></i>
                        <div className="absolute -top-1 -right-1 w-3 h-3 bg-theme-danger rounded-full border border-black animate-pulse"></div>
                    </div>
                </button>
            </div>
        );
    ...
    return (
        <div className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-[90] w-[calc(100vw-2rem)] md:w-80 pointer-events-auto">
            ...
            <div className="bg-theme-surface-glass backdrop-blur-xl border border-theme-primary/30 rounded-lg p-4 shadow-[0_0_30px_rgba(99,102,241,0.15)] relative overflow-hidden animate-in slide-in-from-right duration-500">
                ...
                <div className="absolute top-0 left-0 w-full h-[1px] bg-theme-primary/50 animate-scan"></div>

                <div className="flex items-start gap-4 relative z-10">
                    {/* Icon */}
                    <div className="w-10 h-10 rounded bg-theme-primary/20 text-theme-primary flex items-center justify-center border border-theme-primary/40 shrink-0 animate-pulse mt-1">
                    ...
                    <div className="flex-1 pr-4">
                        <div className="flex justify-between items-center mb-1">
                            <h4 className="text-[10px] font-black text-theme-primary tracking-widest uppercase">
                        ...
                        <h3 className="text-sm font-bold text-theme-text-primary leading-tight mb-1">
                            {currentStep.title}
                        </h3>

                        <p className="text-[11px] text-theme-text-secondary mb-2">
                            {currentStep.text}
                        </p>

                        <p className="text-[10px] text-theme-primary/80 font-mono bg-theme-primary/10 p-1.5 rounded border border-theme-primary/20">
                            &gt; {currentStep.sub}
                        </p>

                        {/* Progress Bar */}
                        <div className="mt-3">
                            <div className="flex items-center justify-between text-[9px] font-mono text-theme-text-muted mb-1">
