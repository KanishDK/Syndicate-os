...
const NavButton = memo(({ active, onClick, icon, color, label, alert }) => (
    <button
        ...
        className={`flex-1 min-w-[70px] md:min-w-[100px] flex md:flex-row flex-col items-center justify-center gap-1 md:gap-2 px-2 md:px-4 py-2 md:py-3 rounded-lg transition-all duration-200 group relative overflow-hidden shrink-0 active:scale-95
        ${active ? 'bg-white/10 text-white shadow-[0_0_20px_rgba(255,255,255,0.05)] border border-white/10' : 'text-zinc-500 border border-transparent active:bg-white/5 active:text-zinc-300'}
