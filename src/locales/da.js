export const da = {
    ...
    rivals: {
        ...
        network: {
            ...
            desc: "Forbind direkte til en anden Syndicate-boss via en krypteret P2P-forbindelse.",
            no_traces: "Ingen servere. Ingen spor. Kun business.",
            host: "Opret Forbindelse",
            join: "Tilslut Netværk",
            lobby_created: "Netværk Oprettet",
            share_code: "Del denne kode med din rival:",
            generating: "Genererer...",
            waiting: "Afventer forbindelse...",
            connected: "RIVAL FORBUNDET",
            cancel: "Annuller Session",
            join_lobby: "Tilslut Lobby",
            paste_code: "Indsæt Lobby Kode...",
            connect: "Forbind",
            connected_host: "FORBUNDET TIL VÆRT",
            disconnect: "Afbryd",
            intel: "Mål Efterretning",
            boss_level: "Level {level} Boss",
            net_worth: "Samlet Værdi",
            liquid_cash: "Likvide Penge",
            heat: "Heat",
            dirty_cash: "Sorte Penge",
            siphon: "STJÆL MIDLER (LÅST)",
            client: "Klient",
            host_label: "Vært"
        },
        grid: {
    ...
    staff: {
        ...
        grower_pro: { name: "Mester-Gartner", desc: "Ekspert i hydro-systemer. Dyrker 3x hurtigere." },
        chemist: { name: "Kemiker", desc: "Koger Speed og andet godt" },
        chemist_cook: { name: "Heisenberg", desc: "Kemi på Nobel-niveau." },
        ...
        pusher_bike: { name: "Cykel-Bud", desc: "Hurtig levering. Sælger dobbelt så hurtigt." },
